...
import SobreFundoLaranja from '../assets/FotosSobreEBlog/SobreFundoLaranja.png';
import SobreFundoRoxo from '../assets/FotosSobreEBlog/SobreFundoRoxo.png';
      ...
      <ScrollView style={styles.scroll}>
        ...
        <View style={styles.aboutView}>
          ...
          <Text style={styles.aboutParagraph}>
            Promover a adoção responsável de cães e gatos, facilitando a conexão
            entre animais resgatados e lares amorosos, além de fornecer recursos
            e orientações para o cuidado adequado dos pets.
          </Text>
        </View>
        ...
        <View style={styles.visionView}>
          ...
          <Text style={styles.visionParagraph}>
            Ser reconhecido como uma plataforma de referência na promoção do
            bem-estar animal, contribuindo para a redução do abandono e
            incentivando a guarda responsável de animais de estimação.
          </Text>
        </View>
        ...
        <View style={styles.valuesView}>
          ...
          <Text style={styles.aboutParagraph}>
            • Empatia: Compreender e atender às necessidades dos animais e seus
