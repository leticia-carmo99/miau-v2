...
import ChatUsuario from '../HomeScreens/ChatUsuario.js';
import Mapa from '../HomeScreens/MapaPetshop';
import Adote from '../HomeScreens/Adote';

// Placeholder screens para as outras abas
function AdoteScreen() {
  return (
    <View style={styles.placeholderContainer}>
      <Text style={styles.placeholderText}>Tela Adote</Text>
    </View>
  );
}
...
export default function Tabs() {
  return (
    ...
    >
      ...
      <Tab.Screen name="HomeTab" component={InicialUser} />
      <Tab.Screen name="ChatTab" component={ChatUsuario} />
      <Tab.Screen name="MapaTab" component={Mapa} />
      <Tab.Screen name="AdoteTab" component={Adote} />
    </Tab.Navigator>
  );
}
