    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.texto}>
          Antes de começar, pediremos que você preencha um formulário com as
          informações da sua instituição. Assim que for aprovado, você (ONG ou
          abrigo) poderá começar a usar o app
        </Text>
      ...
      <TouchableOpacity
        onPress={() => navigation.navigate('FormONG1')}
        style={styles.botao}>
